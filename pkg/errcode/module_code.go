...
var (
	...
	ErrorUserClassListFail   = NewError(20010001, "获取用户分类列表失败")
	ErrorCreateUserClassFail = NewError(20010002, "创建用户分类失败")
	ErrorUpdateUserClassFail = NewError(20010003, "更新用户分类失败")
	ErrorDeleteUserClassFail = NewError(20010004, "删除用户分类失败")
	ErrorCountUserClassFail  = NewError(20010005, "统计用户分类失败")
)
