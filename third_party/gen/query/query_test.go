...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.EnglishDictionary.UnderlyingDB().Statement.Context,
		qCtx.RcQueue.UnderlyingDB().Statement.Context,
		qCtx.RcRole.UnderlyingDB().Statement.Context,
		qCtx.RcUser.UnderlyingDB().Statement.Context,
		qCtx.UserClass.UnderlyingDB().Statement.Context,
		qCtx.UserClassKnowledge.UnderlyingDB().Statement.Context,
		qCtx.UserKnowledge.UnderlyingDB().Statement.Context,
	} {
