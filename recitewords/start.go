...
import (
	...
	"nickygin.com/pkg/tracer"
	"nickygin.com/pkg/validator"
	"nickygin.com/recitewords/internal/models"
	"nickygin.com/recitewords/internal/route"
	_ "nickygin.com/recitewords/internal/route/api/restfuldocs"
...
func setupFlag() error {
	...
	flag.StringVar(&config, "config", "microservices/recitewords/configs/", "指定要使用的配置文件路径")
