...
const TableNameUserClassKnowledge = "user_class_knowledge"
...
type UserClassKnowledge struct {
	...
	KnowledgeID int32      `gorm:"column:knowledge_id;not null" json:"knowledge_id"`
}

// TableName UserClassKnowledge's table name
func (*UserClassKnowledge) TableName() string {
	return TableNameUserClassKnowledge
}
